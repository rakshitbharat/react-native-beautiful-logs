...
exports.getDateString = exports.formatMessage = exports.formatJSON = void 0;
const constants_1 = require("./constants");
const formatJSON = (obj, colors = constants_1.COLORS) => {
...
const formatMessage = (type, messageParts, config) => {
    var _a, _b;
    const timestamp = new Date().toLocaleTimeString();
    const typeUpper = type.toUpperCase().padEnd(5);
    const moduleMatch = (_b = (_a = messageParts[0]) === null || _a === void 0 ? void 0 : _a.match) === null || _b === void 0 ? void 0 : _b.call(_a, /\[(.*?)\]/);
            ...
            try {
                ...
                if (potentialJson.startsWith('{') || potentialJson.startsWith('[')) {
                    try {
                        ...
                        return ('\n' +
                            (0, exports.formatJSON)(parsed, colors)
                                .split('\n')
                ...
                const formatted = (0, exports.formatJSON)(p, colors);
                return ('\n' +
                    formatted
                        .split('\n')
                        .map((line) => `${colors[type]}│${colors.reset}  ${line}`)
